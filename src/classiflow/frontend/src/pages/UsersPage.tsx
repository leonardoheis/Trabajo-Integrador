      ...
      render: (u) => (
        <div className="flex gap-2">
          ...
          <button
            ...
            className="text-base font-medium text-[var(--color-danger)] hover:underline"
          >
            Delete
          </button>
        </div>
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-4 flex gap-2">
        ...
        <button
          onClick={handleAdd}
          className="rounded-md bg-[var(--color-accent)] px-3 py-2 text-base font-semibold text-[var(--color-bg)]"
        >
          Add
        </button>
      </div>
